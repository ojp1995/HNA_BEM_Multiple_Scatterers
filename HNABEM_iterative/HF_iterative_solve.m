...
phi1_0_outer = v_N1_0.eval(G1_data.t_mid_q_comb_outer, 1) ...
    + 2*duidn(vertices1, G1_data.L, kwave, d, G1_data.t_mid_q_comb_outer);
phi1_0_inner = v_N1_0.eval(G1_data.t_mid_q_comb_inner, 1) ...
    + 2*duidn(vertices1, G1_data.L, kwave, d, G1_data.t_mid_q_comb_inner);
...
for r = 2:R_max
    ...
    % variables
    K12_phi2_r =  midpoint_dphikdn_f_diff_screen(kwave, ...
    ...
    Psi_1_r = 2*G1_data.alpha*duidn(vertices1, G1_data.L, kwave, d, ...
        G1_data.t_mid_q_comb_outer) + K12_phi2_r;
    
    S11Psi1_r = graded_PIM_int_hankel_f(kwave, col_points1,...
    ...
    % Now compute K12 phi2_1, x are G1_outer variables, y are G2_inner
    % variables
    K21_phi1_r =  midpoint_dphikdn_f_diff_screen(kwave, ...
        G2_data.x_q_comb_outer, G2_data.y_q_comb_outer, ...
        G1_data.w_comb_inner, G1_data.x_q_comb_inner, ...
        G1_data.y_q_comb_inner, phi1_r_inner, G2_data.n);

    Psi_2_r = 2*G2_data.alpha*duidn(vertices2, G2_data.L, kwave, d, ...
