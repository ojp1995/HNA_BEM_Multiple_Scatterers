...
K21_phi1_0 =  G2_data.beta_outer.*midpoint_dphikdn_f_diff_screen(kwave, ...
...
for r = 2:R_max
    ...
    % variables
    K12_phi2_r = G1_data.beta_outer.*midpoint_dphikdn_f_diff_screen(kwave, ...
    ...
    % Now compute K12 phi2_1, x are G1_outer variables, y are G2_inner
    % variables
    K21_phi1_r =  G2_data.beta_outer.*midpoint_dphikdn_f_diff_screen(kwave, ...
        G2_data.x_q_comb_outer, G2_data.y_q_comb_outer, ...
        G1_data.w_comb_inner, G1_data.x_q_comb_inner, ...
