% reading in data and rearranging, p = 7

clear all
addpath('test5a_p5_7_HNA_pi_4/')

load('test5a_HNA_pmax7_overlap2_quaddof_5_20')
...
load('test5a_HNA_pmax7_overlap2_quaddof_40_80.mat')
...
phi2_HNA = {phi2_HNA_5_20{1}, phi2_HNA_5_20{2}, ...
 ...
 save('test5a_HNA_pmax7_overlap2_dof5_80', 'G1_data_HNA', ...
