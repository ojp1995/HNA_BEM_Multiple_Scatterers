function [aj_1_r, aj_2_r, A1, A2, S12, S21] = PS_2_iterative_2screen_solver(k, G1, G2, f, xps1, yps1, xps2, yps2, C_wl, R_approx, C1, C2)
...
% step 0
u_i_1 = PS_incident(k, xps1, yps1, x1, y1).' + PS_incident(k, xps2, yps2, x1, y1).';
aj_1_r(:, 1) = A1\u_i_1;
...
u_i_2 = PS_incident(k, xps1, yps1, x2, y2).' + PS_incident(k, xps2, yps2, x2, y2).' - S21*aj_1_r(:, 1);  
aj_2_r(:, 1) = A2\u_i_2;
...
for r = 2:R_approx
    ...
    % solve on \Gamma_{1}
    u_i_1 = PS_incident(k, xps1, yps1, x1, y1).' + PS_incident(k, xps2, yps2, x1, y1).' - S12*aj_2_r(:, r-1);
    aj_1_r(:, r) = A1\u_i_1;
    
    % solve on \Gamma_{2}
    u_i_2 = PS_incident(k, xps1, yps1, x2, y2).' + PS_incident(k, xps2, yps2, x2, y2).' - S21*aj_1_r(:, r);  
    aj_2_r(:, r) = A2\u_i_2;
