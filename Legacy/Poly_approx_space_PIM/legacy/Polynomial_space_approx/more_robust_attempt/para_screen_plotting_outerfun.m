%parallel screens plotting of a few examples as there is going to be a lot
%of reflections so lots of plots

clear all

% introducing the screens
len = 2  % length of the screen
d = 2*pi; % distance between the screens
% switch and things get interesting
G2 = [-len*pi, len*pi, 0, 0];

G1 = [d - len*pi, len*pi, d, 0]; 
...
[err_normG1_it, err_normG2_it, aj_1_r, aj_2_r] = it_conv_test_fixed_dof( G1, G2, k, C1, C2, theta, C_wl, R_it, R_true); 
