function [x_1, y_1, x_2, y_2, t_grid, t_mid, w, L] = ...
    given_N_discretistion_vars_graded(G, N, Lgrad_coeff, alpha)
% ADAPTED - so that we can fix the number of intervals to N, rather than
% 1/C_wl.
%
