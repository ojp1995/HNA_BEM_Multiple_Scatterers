function [f_ell, ddn_S_ell_j_phij,S_ell_j_phi_j, S_ell_ell_Psi_ell_r, Psi_ell_r] ...
    = compute_RHS_vec_given_coll_vec(Gamma_ell, L_ell, k, d, ...
...
S_ell_ell_Psi_ell_r = PIM_int_hankel_f(k, s_ell, h_ell_outer_PIM, ...
nq_ell_PIM, Psi_ell_r, tq_ell_PIM, C1, C2);

f_ell = incident(k, theta, x1s_ell, x2s_ell) ...
    - S_ell_j_phi_j - S_ell_ell_Psi_ell_r;
